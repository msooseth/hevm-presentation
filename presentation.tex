...
%Keccak, i.e. SHA-3 is used extensively by all contracts in EVM. This is because e.g. \textbf{storage of contracts is an unstructured array} of uint256. Hence, to implement e.g. maps and an arrays, one needs to use Keccak to map to a "random" position in storage, so as not to clash.
%\bigskip
%
