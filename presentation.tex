...
\node (dec1) [decision, right of=program, xshift=7cm]
...
\draw [arrow3] (program) --node[anchor=south] {\tiny Symb. Interp.} (dec1);
...
\draw [arrow2] (dec3) --node[anchor=north]{False}  (pro3);
\draw [arrow]  (dec3) --node[anchor=north]{True}   (pro4);
