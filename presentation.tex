...
\begin{frame}{Example: The Great Verification of ABDK Math 64.64}
    \centering
    An effort to verify mathematical properties in ABDK Math 64x64 using echidna/hevm.
    \vfill
    \includegraphics[scale=0.15]{abdk-table-1}\quad\includegraphics[scale=0.15]{abdk-table-2}
    \vfill
...
\begin{frame}[fragile=singleslide]{Overall Effect of Improvements}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Easy-to-use: test setup via forge-std cheatcodes, standalone CLI
